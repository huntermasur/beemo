...
- Scaffold steps must be failure-tolerant: a failing step warns (in BMO voice), skips,
...
- Keep BMO's personality in user-facing strings, but never in generated project files
